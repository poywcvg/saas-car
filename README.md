...
چرخیار یک پلتفرم **چندمستأجری (multi-tenant)** است که به کسب‌وکارهای خدمات خودرو کمک می‌کند مشتریان و خودروهایشان را مدیریت کنند و موعد سرویس‌ها را به‌موقع یادآوری کنند. پلتفرم چندمحصولی است و **«تعویض روغن» نخستین محصولِ فعال (پرچم‌دار)** آن است؛ محصولات دیگر به‌تدریج اضافه می‌شوند.
...
- 🏢 **چندمستأجری با ساب‌دامین** — هر کسب‌وکار سایت اختصاصی خود را روی `<subdomain>.charkhyar.ir` دارد
